...
class MediaSelector extends PureComponent {
  ...
  getPermissions = async () => {
    ...
    this.setState({
      hasCameraPermission: cameraroll.tatus === 'granted',
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          >
            <Text color={colors.danger} button>
              Cancel
            </Text>
          </Button>
          ...
          <Button small rounded color={colors.success} onPress={this.onNext}>
            <Text color={colors.milkyWhite} button bold>
              Upload
            </Text>
          </Button>
        </Block>
