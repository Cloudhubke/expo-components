...
const StaticListSelector: React.FC<{
  value?: any;
  input?: any;
  labelExtractor: (value?: any) => string;
  secondaryLabelExtractor: (value?: any) => string;
...
StaticListSelector.defaultProps = {
  ...
  keyExtractor: (value: any) => value.id || value,
  valueExtractor: (value: any) => value.id || value,
  labelExtractor: (value: any) => value.id || value,
  secondaryLabelExtractor: (value: any) => value.id || value,
  onSelectChange: () => {},
  displayField: '',
  returnkeys: [],
  inputStyle: {},
